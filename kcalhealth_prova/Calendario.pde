...
class Calendario {
  ...
  void display(){
    textAlign(CORNER); textFont(fuente2); textSize(15); fill (105, 109, 125);
    text(months[mes-1]+"/"+any, x, y - 5);
    ...
    if(dateSelected){
      ...
      textAlign(CENTER); textFont(fuente2); textSize(12); fill (105, 109, 125);
      text(dateText, x+w-40, y - 5);
    }
  }
